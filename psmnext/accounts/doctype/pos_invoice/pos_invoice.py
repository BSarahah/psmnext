...
from psmnext.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
from psmnext.accounts.doctype.payment_request.payment_request import make_payment_request
...
from psmnext.controllers.queries import item_query as _item_query
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from psmnext.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
