...
from psmnext.accounts.doctype.journal_entry.journal_entry import StockAccountInvalidTransaction
from psmnext.exceptions import InvalidAccountCurrency
...
class TestJournalEntry(unittest.TestCase):
	...
	def test_reverse_journal_entry(self):
		from psmnext.accounts.doctype.journal_entry.journal_entry import make_reverse_journal_entry
