...
from psmnext.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool import (
	get_linked_payments,
	reconcile_vouchers,
)
...
from psmnext.tests.utils import if_lending_app_installed
...
class TestBankTransaction(FrappeTestCase):
	...
	# This test checks if psmnext is able to provide a linked payment for a bank transaction based on the amount of the bank transaction.
	...
	# Check if psmnext can correctly filter a linked payments based on the debit/credit amount
