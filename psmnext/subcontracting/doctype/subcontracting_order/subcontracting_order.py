...
from psmnext.buying.doctype.purchase_order.purchase_order import is_subcontracting_order_created
...
class SubcontractingOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from psmnext.subcontracting.doctype.subcontracting_order_item.subcontracting_order_item import (
			SubcontractingOrderItem,
		)
		from psmnext.subcontracting.doctype.subcontracting_order_service_item.subcontracting_order_service_item import (
			SubcontractingOrderServiceItem,
		)
		from psmnext.subcontracting.doctype.subcontracting_order_supplied_item.subcontracting_order_supplied_item import (
