...
from psmnext.setup.doctype.employee.employee import get_holiday_list_for_employee
from psmnext.stock.doctype.serial_no.serial_no import get_serial_nos
from psmnext.utilities.transaction_base import TransactionBase, delete_events
...
class MaintenanceSchedule(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from psmnext.maintenance.doctype.maintenance_schedule_detail.maintenance_schedule_detail import (
			MaintenanceScheduleDetail,
		)
		from psmnext.maintenance.doctype.maintenance_schedule_item.maintenance_schedule_item import (
