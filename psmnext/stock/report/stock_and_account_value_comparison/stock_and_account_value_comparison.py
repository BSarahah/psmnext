...
import psmnext
from psmnext.accounts.utils import get_currency_precision, get_stock_accounts
from psmnext.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account


def execute(filters=None):
	if not psmnext.is_perpetual_inventory_enabled(filters.company):
		frappe.throw(
