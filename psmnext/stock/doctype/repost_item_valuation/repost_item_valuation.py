...
import psmnext
from psmnext.accounts.general_ledger import validate_accounting_period
from psmnext.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from psmnext.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(psmnext.is_perpetual_inventory_enabled(doc.company)):
		return
