frappe.provide("psmnext.timesheet");

psmnext.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	psmnext.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

psmnext.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
