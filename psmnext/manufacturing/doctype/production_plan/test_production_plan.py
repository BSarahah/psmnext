...
from psmnext.manufacturing.doctype.work_order.work_order import make_stock_entry as make_se_from_wo
...
class TestProductionPlan(FrappeTestCase):
	...
	def test_production_plan_subassembly_default_supplier(self):
		from psmnext.manufacturing.doctype.bom.test_bom import create_nested_bom
	...
	def test_production_plan_for_subcontracting_po(self):
		from psmnext.manufacturing.doctype.bom.test_bom import create_nested_bom
		from psmnext.subcontracting.doctype.subcontracting_bom.test_subcontracting_bom import (
