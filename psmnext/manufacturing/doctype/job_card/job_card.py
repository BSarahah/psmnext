...
from psmnext.manufacturing.doctype.workstation_type.workstation_type import get_workstations
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from psmnext.manufacturing.doctype.job_card_item.job_card_item import JobCardItem
		from psmnext.manufacturing.doctype.job_card_operation.job_card_operation import JobCardOperation
		from psmnext.manufacturing.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from psmnext.manufacturing.doctype.job_card_scrap_item.job_card_scrap_item import (
			JobCardScrapItem,
		)
		from psmnext.manufacturing.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog
