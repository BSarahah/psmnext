...
from psmnext.stock.doctype.item.item import get_item_details
from psmnext.stock.get_item_details import get_conversion_factor, get_price_list_rate
...
class BOM(WebsiteGenerator):
	...
	if TYPE_CHECKING:
		...
		from psmnext.manufacturing.doctype.bom_explosion_item.bom_explosion_item import BOMExplosionItem
		from psmnext.manufacturing.doctype.bom_item.bom_item import BOMItem
		from psmnext.manufacturing.doctype.bom_operation.bom_operation import BOMOperation
		from psmnext.manufacturing.doctype.bom_scrap_item.bom_scrap_item import BOMScrapItem
	...
	def company_currency(self):
		return psmnext.get_company_currency(self.company)
...
def add_operations_cost(stock_entry, work_order=None, expense_account=None):
	from psmnext.stock.doctype.stock_entry.stock_entry import get_operating_cost_per_unit
...
def make_variant_bom(source_name, bom_no, item, variant_items, target_doc=None):
	from psmnext.manufacturing.doctype.work_order.work_order import add_variant_item
