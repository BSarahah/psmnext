...
from psmnext.stock.deprecated_serial_batch import (
	DeprecatedBatchNoValuation,
	DeprecatedSerialNoValuation,
)
from psmnext.stock.valuation import round_off_if_near_zero
...
class SerialBatchBundle:
	...
	def make_serial_batch_no_bundle_for_material_transfer(self):
		from psmnext.controllers.stock_controller import make_bundle_for_material_transfer
	...
	def set_warehouse_and_status_in_serial_nos(self):
		from psmnext.stock.doctype.serial_no.serial_no import get_serial_nos as get_parsed_serial_nos
