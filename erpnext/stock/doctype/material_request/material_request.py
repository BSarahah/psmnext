...
from psmnext.stock.stock_balance import get_indented_qty, update_bin_qty
...
class MaterialRequest(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from psmnext.stock.doctype.material_request_item.material_request_item import MaterialRequestItem
	...
	def validate(self):
		...
		from psmnext.controllers.status_updater import validate_status
