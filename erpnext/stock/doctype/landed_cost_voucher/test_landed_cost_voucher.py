...
from psmnext.accounts.utils import update_gl_entries_after
from psmnext.assets.doctype.asset.test_asset import create_asset_category, create_fixed_asset_item
...
class TestLandedCostVoucher(FrappeTestCase):
	...
	def test_do_not_validate_landed_cost_voucher_with_serial_batch_for_legacy_pr(self):
		from psmnext.stock.doctype.item.test_item import make_item
		from psmnext.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import get_auto_batch_nos
