...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "psmnext")
	try:
		...
		capture("demo_data_creation_failed", "psmnext", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "psmnext")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "psmnext")
	try:
...
def make_transactions(company):
	...
	from psmnext.accounts.utils import FiscalYearError
