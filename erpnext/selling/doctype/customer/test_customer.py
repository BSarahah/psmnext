...
from psmnext.accounts.party import get_due_date
from psmnext.exceptions import PartyDisabled, PartyFrozen
from psmnext.selling.doctype.customer.customer import (
	get_credit_limit,
	get_customer_outstanding,
	parse_full_name,
)
from psmnext.tests.utils import create_test_contact_and_address
...
class TestCustomer(FrappeTestCase):
	...
	def test_party_details(self):
		from psmnext.accounts.party import get_party_details
