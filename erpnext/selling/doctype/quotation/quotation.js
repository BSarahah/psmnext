...
psmnext.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
psmnext.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
psmnext.pre_sales.set_as_lost("Quotation");
...
psmnext.selling.QuotationController = class QuotationController extends psmnext.selling.SellingController {
	onload(doc, dt, dn) {
	...
	get_lead_details() {
		...
		frappe.call({
			method: "psmnext.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(psmnext.selling.QuotationController);
