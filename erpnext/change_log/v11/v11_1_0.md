- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any psmnext user can list their products and be discovered by thousands of other companies using psmnext
...
- Changes have been made to ensure psmnext is compatible with Python 3
