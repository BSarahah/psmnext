...
from psmnext.buying.doctype.purchase_order.test_purchase_order import prepare_data_for_internal_transfer
...
class TestAccountsController(FrappeTestCase):
	...
	def test_16_internal_transfer_at_arms_length_price(self):
		from psmnext.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_purchase_invoice
