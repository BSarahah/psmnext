...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from psmnext.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from psmnext.accounts.doctype.applicable_on_account.applicable_on_account import (
			ApplicableOnAccount,
		)
