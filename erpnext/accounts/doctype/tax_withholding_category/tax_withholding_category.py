...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from psmnext.accounts.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from psmnext.accounts.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate
