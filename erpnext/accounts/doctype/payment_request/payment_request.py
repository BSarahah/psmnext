...
from psmnext.accounts.doctype.subscription_plan.subscription_plan import get_plan_rate
from psmnext.accounts.party import get_party_account, get_party_bank_account
from psmnext.accounts.utils import get_account_currency, get_currency_precision
from psmnext.utilities import payment_app_import_guard
...
class PaymentRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from psmnext.accounts.doctype.subscription_plan_detail.subscription_plan_detail import (
