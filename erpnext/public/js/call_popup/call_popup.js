			...
			fields: [
				...
				},
				{
					...
					click: () => {
						...
						frappe
							.xcall(
								"psmnext.telephony.doctype.call_log.call_log.add_call_summary_and_call_type",
								{
